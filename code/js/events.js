...
Usage:
	bindEvent("eventName", function(param1, param2, ..) {});
	emitEvent("eventName", param1, param2, ..);
	unbindEvent("eventName", functionWasBinded);
*/
(function (window) {
	var _events_binds = {};

	window['bindEvent'] = function(eventID, func){
	...
	window['unbindEvent'] = function(eventID, func){
		eventID = eventID.toLowerCase();
	...
	window['emitEvent'] = function(eventID){
		eventID = eventID.toLowerCase();
